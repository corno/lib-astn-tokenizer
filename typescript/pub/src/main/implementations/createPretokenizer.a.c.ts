        ...
        return $d.createStringSplitter.construct({
            'handler': {
                'data': ($) => {
                    ...
                    $s_state.position = $d.updatePosition({
                    ...
                    pl.optional(
                                        ...
                                        case 'carriage return':
                                            pl.cc($s[1], () => {
                                                switch ($[0]) {
                                                    case 'carriage return':
                                                        pl.cc($[1], () => {
                                                            //only send a newline event for the previous newline
                                                            $s_state.handler.data(['newline', ['cr', null]])
                                                        })
                                                        break
                                                    case 'line feed':
                                                        pl.cc($[1], () => {
                                                            $s_state.handler.data(['newline', ['crlf', null]])
                                        ...
                                        case 'line feed':
                                            pl.cc($s[1], () => {
                                                ...
                                                switch ($[0]) {
                                                    case 'carriage return':
                                                        pl.cc($[1], () => {
                                                            $s_state.handler.data(['newline', ['lfcr', null]])
                                                            $s_state['found newline'] = [false]
                                                        })
                                                        break
                                                    case 'line feed':
                                                        pl.cc($[1], () => {
                                                            //only send a newline event for the previous newline
                                                            $s_state.handler.data(['newline', ['lf', null]])
                        ...
                        () => {
                            ...
                            switch ($s.context[0]) {
                                case 'non wrapped':
                                    pl.cc($s.context[1], ($s) => {
                                        //currently no string is being processed
                        ...
                        case 'non wrapped':
                            pl.cc($s['context'][1], ($s) => {
                                switch ($s.found[0]) {
                                    // case 'newlineCharacter':
                                    //     pl.cc($s.found[1], ($s) => {
                                    //         $s_state.handler.data(['newline', null])
                                    //     })
                                    //     break
                                    case 'nothing':
                                        pl.cc($s.found[1], ($s) => {
