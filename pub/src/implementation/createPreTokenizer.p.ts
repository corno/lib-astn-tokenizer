...
type NoneContext = {
    foundNewlineCharacter: null | FoundNewlineCharacter
    foundSolidus: null | api.LocationInfo
}
...
export function createPreTokenizer(
    ...
    let currentToken: CurrentToken = ["none", { foundNewlineCharacter: null, foundSolidus: null }]
